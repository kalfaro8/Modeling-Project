...
for seed in SEEDS:
    ...
    model = RandomForestRegressor(**MODEL_PARAMS, random_state=seed, n_jobs=-1)
    ...
    for train_idx, val_idx in tscv.split(X):
        ...
        model_fold = RandomForestRegressor(**MODEL_PARAMS, random_state=seed, n_jobs=-1)
    ...
    for i in range(len(X)):
        ...
        model_loo = RandomForestRegressor(**MODEL_PARAMS, random_state=seed, n_jobs=-1)
